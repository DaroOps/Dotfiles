...
export class PlaylistTracker extends HTMLElement {
    ...
    render() {
        ...
        this.shadowRoot.innerHTML = `
          ...
          <iframe class="playlist-iframe" src="https://open.spotify.com/embed/album/spotify:album:${this.id}" frameborder="0" allowtransparency="true" allow="storage-access-management"></iframe>
        `;
