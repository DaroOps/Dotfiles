...
const reports = [
  {
    section: "Clients",
    title: "1. (1) List all Spanish customers names.",
                 ...
                 <div class="report__card">
                        ...
                        <div class="card__body">
                            <div class="body__marck">
                                <p><b>Nombre del empleado: </b>${data.client_name}</p>
                        </div>
                    </div>
                </div>
            `;
...
const createReport = (report) => {
  ...
  let fragment = ` <details id="queryDetails${report.title}">
                        <summary>
...
const generateInfo = (report) => {
  const queryDetails = document.querySelector(`#queryDetails${report.title}`);
