...
export const getRequestByCodeClient = async (code) => {
    const res = await fetch(`http://localhost:5508/requests?code_client=${code}`);
    return await res.json();
};

export const getRequestByDetails = async (code) => {
    const res = await fetch(`http://localhost:5508/requests?code_request=${code}`);
    return await res.json();
};
...
export const getAllLateRequest = async () => {
    const res = await fetch("http://localhost:5508/requests?status=Entregado");
    const data = await res.json();
...
export const getRejectRequestsByYear = async (year = 2009) => {
    const res = await fetch("http://localhost:5508/requests?status=Rechazado");
    const data = await res.json();
