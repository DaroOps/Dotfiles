...
export const getCEOInformation = async () => {
    const ceo = await getEmployByBossCode(null); 
    const ceoEmployee = ceo.find(employee => employee.code_boss === null); 
    return {
        puesto: ceoEmployee.position,
        nombre: ceoEmployee.name,
        apellidos: `${ceoEmployee.lastname1} ${ceoEmployee.lastname2}`,
