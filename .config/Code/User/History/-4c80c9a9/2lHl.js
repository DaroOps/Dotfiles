    ...
    val.addEventListener("click", (e) => {
        ...
        if (e.target.innerHTML == "employees") {
            report__details.innerHTML = /*html*/`
                ...
                <drop-card owner="Garden" title="7.(multi-e) Returns a list that shows only employees who do not have a client associated with them." category="Employee" data-event-name="multi-e5"></drop-card>
