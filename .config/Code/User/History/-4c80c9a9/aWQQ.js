...
btn.forEach(val => {
    val.addEventListener("click", (e) => {
        ...
        if (e.target.innerHTML == "product") {
            ...
            <drop-card owner="Garden" title="8.(multi-e) Returns a list of products that have never appeared in an order.." category="Product" data-event-name="single15"></drop-card>
