    ...
    val.addEventListener("click", (e) => {
        ...
        if (e.target.innerHTML == "clients") {
            report__details.innerHTML = /*html*/`
              ...
              <drop-card owner="Garden" title="11.(multi-e) Returns a list showing the customers who have not made any payments and those who have not placed any orders." category="Client" data-event-name="multi-e11"></drop-card>
        ...
        if (e.target.innerHTML == "employees") {
            report__details.innerHTML = /*html*/`
                ...
                <drop-card owner="Garden" title="12.(multi-e) Returns the offices where none of the employees who have been the sales representatives of a client who has made the purchase of a product from the Frutales range work.." category="Employee" data-event-name="multi-e12"></drop-card>
