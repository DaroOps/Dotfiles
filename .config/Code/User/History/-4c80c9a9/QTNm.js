    ...
    val.addEventListener("click", (e) => {
        ...
        if (e.target.innerHTML == "employees") {
            report__details.innerHTML = /*html*/`
                ...
                <drop-card owner="Garden" title="6.(multi-e) Returns a list that shows only the employees who do not have an associated client along with the data of the office where they work." category="Employee" data-event-name="multi-e5"></drop-card>
                <drop-card owner="Garden" title="7.(multi-e) Returns a list showing employees who do not have an associated office and those who do not have an associated client." category="Employee" data-event-name="multi-e5"></drop-card>
        ...
        if (e.target.innerHTML == "product") {
            ...
            <drop-card owner="Garden" title="8.(multi-e) Returns a list with all the products that belong to the Ornamental range and that have more than 100 units in stock. The list must be ordered by their sales price, showing the highest prices first." category="Product" data-event-name="single15"></drop-card>
