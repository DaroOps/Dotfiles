    ...
    val.addEventListener("click", (e) => {
        ...
        if (e.target.innerHTML == "clients") {
            report__details.innerHTML = /*html*/`
              ...
              <drop-card owner="Garden" title="10.(multi-e) Returns the name of customers to whom an order has not been delivered on time." category="Client" data-event-name="multi-e1"></drop-card>
