    ...
    val.addEventListener("click", (e) => {
        ...
        if (e.target.innerHTML == "employees") {
            report__details.innerHTML = /*html*/`
                ...
                <drop-card owner="Garden" title="4.(multi-e) Returns a list showing the customers who have not made any payments and those who have not placed any orders." category="Client" data-event-name="multi-e3"></drop-card>
              `;
        }
