    ...
    val.addEventListener("click", (e) => {
        ...
        if (e.target.innerHTML == "employees") {
            report__details.innerHTML = /*html*/`
                ...
                <drop-card owner="Garden" title="4.(multi-e) Returns a list showing only employees who do not have an associated office." category="Client" data-event-name="multi-e3"></drop-card>
              `;
        }
