    ...
    val.addEventListener("click", (e) => {
        ...
        if (e.target.innerHTML == "clients") {
            report__details.innerHTML = /*html*/`
              ...
              <drop-card owner="Garden" title="10.(multi-e) Returns a list showing only customers who have not made any payments." category="Client" data-event-name="multi-e1"></drop-card>
